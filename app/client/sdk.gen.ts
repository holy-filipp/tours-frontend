 ...
 */
export const c3893Ea1Ca41948Fc2Ab2Ef3A0209 = <ThrowOnError extends boolean = false>(options?: Options<C3893Ea1Ca41948Fc2Ab2Ef3A0209Data, ThrowOnError>) => {
    return (options?.client ?? client).post<C3893Ea1Ca41948Fc2Ab2Ef3A0209Responses, C3893Ea1Ca41948Fc2Ab2Ef3A0209Errors, ThrowOnError>({
        url: '/api/user/signin',
        ...options,
        headers: {
            'Content-Type': 'application/json',
